...
export class BlogArticle extends UuidEntity {
  ...
  /**
   * Per-locale title, content HTML, and meta description. Public catalog and
   * blog routes resolve through this; the top-level `title`/`contentHtml`
   * columns remain the canonical English source of truth.
   */
  @Column({
    type: 'jsonb',
    default: () => `'{}'::jsonb`,
  })
  translations?: Translations<'title' | 'content_html' | 'meta_description'>;
}
